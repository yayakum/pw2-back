...
const createPost = async (req, res) => {
    try {
        ...
        if (followers.length > 0) {
            ...
            // Usar el método de notificaciones masivas del socket manager
            await socketManager.createBulkNotifications({
                type: 'new_post',
                userIds: followerIds,
...
// Obtener publicaciones de los usuarios que sigo (sin paginación)
